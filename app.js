...
setInterval(() => {
    TodayD = new Date();
    dateT  = TodayD.toLocaleDateString('en-GB');
    dayT   = TodayD.toLocaleString('en-us', {weekday:'long'});

    TodayD = (TodayD.getHours() < 10 ? '0' + TodayD.getHours() : '' + TodayD.getHours()) + ":" + 
             (TodayD.getMinutes() < 10 ? '0' + TodayD.getMinutes() : '' + TodayD.getMinutes()) + ":" + 
             (TodayD.getSeconds() < 10 ? '0' + TodayD.getSeconds() : '' + TodayD.getSeconds());

    document.getElementById("time").innerHTML = TodayD + " on " + dateT + ", " + dayT;
